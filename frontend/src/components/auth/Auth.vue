<template>
   <div class="auth-content">
     <div class="auth-modal">
        ...
        <input v-if="showSignup" v-model="user.cpassword" type="password" placeholder="Confirme a senha">
        <input v-if="showSignup" v-model="user.admin" type="checkbox" placeholder="Administrador">
...
export default {
   ...
   methods:{
       ...
       signup(){
         ...
         axios.post(`${baseApiUrl}/i`,this.user)
           .then(()=>{
